...
ALTER DATABASE madiva_copy SET EMERGENCY
GO
ALTER DATABASE madiva_copy SET single_user
GO
DBCC CHECKDB (madiva_copy, REPAIR_ALLOW_DATA_LOSS) WITH ALL_ERRORMSGS
GO
ALTER DATABASE madiva_copy SET multi_user
GO
...
ALTER DATABASE Clinic_Linkage_Sample SET EMERGENCY
GO
ALTER DATABASE Clinic_Linkage_Sample SET single_user
GO
DBCC CHECKDB (Clinic_Linkage_Sample, REPAIR_ALLOW_DATA_LOSS) WITH ALL_ERRORMSGS
GO
ALTER DATABASE Clinic_Linkage_Sample SET multi_user
GO
