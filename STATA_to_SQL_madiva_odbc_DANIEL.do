...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
use "D:\APHRC\GoogleDrive_ii\data_science\madiva\DMAC\databases\individual_ses\individual_ses_raw.dta", clear
odbc insert, table("individual_ses_raw") dsn("madiva_system") create
//------------------------------------------------------------------------------

//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
use "D:\Daniels\1_Data_Madiva\anonymizers\ANONYMIZER_INDIVIDUALID.dta", clear
odbc insert, table("ANONYMIZER_INDIVIDUALID") dsn("madiva_system") create
//------------------------------------------------------------------------------
use "D:\Daniels\1_Data_Madiva\anonymizers\ANONYMIZER_INDIVIDUALID_refined.dta", clear
odbc insert, table("ANONYMIZER_INDIVIDUALID_refined") dsn("madiva_system") create
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
use "D:\Daniels\1_Data_Madiva\anonymizers\ANONYMIZER_SOCIALGROUPID.dta", clear
odbc insert, table("ANONYMIZER_SOCIALGROUPID") dsn("madiva_system") create
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
use "D:\Daniels\1_Data_Madiva\anonymizers\ANONYMIZER_SOCIALGROUPID_cleaned.dta", clear
odbc insert, table("ANONYMIZER_SOCIALGROUPID_cleaned") dsn("madiva_system") create
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
...
// Format date variables
local date_var res_eventdate res_datebeg res_hhh_datebirth res_datebirth pge_pregid
foreach m of local date_var {
    local mcode = `mcode' + 1
    display "`mcode': `m'"
...
//******************************************************************************
//Insert in SQL Server
odbc insert, table("residency_cov_anon_portal_2018") dsn("madiva_system") create
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
//Verbal Autopsy (VA)
use "D:\Daniels\1_Data_Madiva\VA\verbalautopsy_symptoms_anon.dta", clear
...
//------------------------------------------------------------------------------
. use "D:\APHRC\GoogleDrive_ii\data_science\madiva\DMAC\Marylene_DOK\allDSSpopulation_long_prepared_cal_age_cov_char.dta" 

// Work on dates
local res_datebeg res_eventdate res_ind_datebirth res_ind_dateintodsa res_ind_dateoutofdsa res_hhh_datebirth res_inmvmt_dsaoutmigdate
foreach m of local date_var {
    local mcode = `mcode' + 1
    display "`mcode': `m'"
...
save "altered_allDSSpopulation_long_prepared_cal_age_cov_char.dta", replace

odbc insert, table("allDSSpopulation_cal_age_cov_char") dsn("madiva_system") create
